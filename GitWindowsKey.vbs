...
strProductKey ="Windows Key: " & WinProductKey & vbNewLine & vbNewLine & "-  刁小帅"& vbNewLine & "-  www.diaoxiaoshuai.com"
WinProductID = WinProductName & WinProductID & strProductKey 

MsgBox(WinProductID)
Dim ret
ret = InputBox(vbNewLine & "你可在下面自行复制序列号："& vbNewLine & vbNewLine & "[ 点击确定或取消退出本程序 ]" ,"Win10 序列号查看器 - diaoxiaoshuai.com",WinProductKey)
